class Brack < Formula
  ...
  #       url "https://github.com/brack-lang/brack/releases/download/v0.2.0/brack-x86_64-darwin"
  #       sha256 ""
  ...
  #     if Hardware::CPU.arm?
  #       url "https://github.com/brack-lang/brack/releases/download/v0.2.0/brack-aarch64-darwin"
  #       sha256 ""
  ...
  #   on_linux do
  #     if Hardware::CPU.intel?
  #       url "https://github.com/brack-lang/brack/releases/download/v0.2.0/brack-x86_64-linux"
  #       sha256 ""
